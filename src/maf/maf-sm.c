...
void maf_state_initial(ogs_fsm_t *s, maf_event_t *e)
{
    ...
    OGS_FSM_TRAN(s, &maf_state_operational);
}
...
void maf_state_operational(ogs_fsm_t *s, maf_event_t *e)
{
    ...
    case OGS_EVENT_SBI_SERVER:
        ...
        // CASE(OGS_SBI_SERVICE_NAME_NMAF_DR)
        //     SWITCH(message.h.resource.component[0])
        //     CASE(OGS_SBI_RESOURCE_NAME_SUBSCRIPTION_DATA)
        //         SWITCH(message.h.resource.component[2])
        //         CASE(OGS_SBI_RESOURCE_NAME_AUTHENTICATION_DATA)
        //             maf_nmaf_dr_handle_subscription_authentication(
        //                     stream, &message);
        //             break;

        //         CASE(OGS_SBI_RESOURCE_NAME_CONTEXT_DATA)
        //             maf_nmaf_dr_handle_subscription_context(stream, &message);
        //             break;
        ...
        //                     maf_nmaf_dr_handle_subscription_provisioned(
        //                             stream, &message);
        //                     break;
        //                 DEFAULT
        //                     ogs_error("Invalid HTTP method [%s]",
        ...
        //         maf_nmaf_dr_handle_policy_data(stream, &message);
        //         break;
    ...
    default:
        ogs_error("No handler for event %s", maf_event_get_name(e));
        break;
    }
}
