        ...
        tgf_ue_t *tgf_ue, void *data)
{
    ...
    message.h.resource.component[1] = tgf_ue->supi;
        ...
        tgf_ue_t *tgf_ue, void *data)
{
    ...
    if (tgf_ue->auth_event->auth_removal_ind) {
            message.h.method = (char *)OGS_SBI_HTTP_METHOD_DELETE;
    } else {
        message.AuthEvent = OpenAPI_auth_event_copy(
                message.AuthEvent, tgf_ue->auth_event);
    }
        ...
        tgf_ue_t *tgf_ue, void *data)
{
    ...
    message.h.resource.component[0] =
        (char *)OGS_SBI_RESOURCE_NAME_SUBSCRIPTION_DATA;
    message.h.resource.component[1] = (char *)tgf_ue->supi;
    message.h.resource.component[2] =
        (char *)OGS_SBI_RESOURCE_NAME_CONTEXT_DATA;
    message.h.resource.component[3] =
        (char *)OGS_SBI_RESOURCE_NAME_AMF_3GPP_ACCESS;
        ...
        tgf_ue_t *tgf_ue, void *data)
{
    ...
    sendmsg.h.resource.component[0] =
        (char *)OGS_SBI_RESOURCE_NAME_SUBSCRIPTION_DATA;
    sendmsg.h.resource.component[1] = tgf_ue->supi;
    sendmsg.h.resource.component[2] =
        (char *)ogs_plmn_id_to_string(&tgf_ue->guami.plmn_id, buf);
