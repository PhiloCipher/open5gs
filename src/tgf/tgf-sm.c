...
void tgf_state_initial(ogs_fsm_t *s, tgf_event_t *e)
{
    tgf_sm_debug(e);

    ogs_assert(s);

    OGS_FSM_TRAN(s, &tgf_state_operational);
}

void tgf_state_final(ogs_fsm_t *s, tgf_event_t *e)
{
    tgf_sm_debug(e);
}

void tgf_state_operational(ogs_fsm_t *s, tgf_event_t *e)
{
    int rv;
    ...
    case OGS_EVENT_SBI_SERVER:
        ...
        //     if (!tgf_ue) {
        //         tgf_ue = tgf_ue_find_by_suci_or_supi(
        //                 message.h.resource.component[0]);
        //         if (!tgf_ue) {
        //             tgf_ue = tgf_ue_add(message.h.resource.component[0]);
        //             if (!tgf_ue) {
        ...
        //             sess = tgf_sess_find_by_psi(tgf_ue, psi);
        //             if (!sess) {
        //                 sess = tgf_sess_add(tgf_ue, psi);
        //                 ogs_assert(sess);
        //                 ogs_debug("[%s:%d] TGF session added",
        //                         tgf_ue->supi, sess->psi);
        //             }
        //         }
        ...
        //         if (OGS_FSM_CHECK(&sess->sm, tgf_sess_state_exception)) {
        //             ogs_error("[%s:%d] State machine exception",
        //                     tgf_ue->suci, sess->psi);
        //             tgf_sess_remove(sess);
        //         }
        //         break;

        //     DEFAULT
        //         ogs_assert(OGS_FSM_STATE(&tgf_ue->sm));

        //         e->tgf_ue = tgf_ue;
        //         e->h.sbi.message = &message;
        //         ogs_fsm_dispatch(&tgf_ue->sm, e);
        //         if (OGS_FSM_CHECK(&tgf_ue->sm, tgf_ue_state_exception)) {
        //             ogs_error("[%s] State machine exception", tgf_ue->suci);
    ...
    case OGS_EVENT_SBI_CLIENT:
        ...
        //             if (message.res_status == OGS_SBI_HTTP_STATUS_OK)
        //                 tgf_nnrf_handle_nf_discover(sbi_xact, &message);
        //             else
        //                 ogs_error("HTTP response error [%d]",
        //                         message.res_status);
        //             break;
        ...
        //             sess = (tgf_sess_t *)sbi_xact->sbi_object;
        //             ogs_assert(sess);
        ...
        //             sess = tgf_sess_cycle(sess);
        //             if (!sess) {
        //                 ogs_error("SESS Context has already been removed");
        //                 break;
        //             }

        //             tgf_ue = tgf_ue_cycle(sess->tgf_ue);
        //             if (!tgf_ue) {
        ...
        //             tgf_ue = (tgf_ue_t *)sbi_xact->sbi_object;
        //             ogs_assert(tgf_ue);
    ...
    default:
        ogs_error("No handler for event %s", tgf_event_get_name(e));
        break;
    }
}
