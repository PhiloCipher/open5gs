...
cJSON *OpenAPI_area_event_info_convertToJSON(OpenAPI_area_event_info_t *area_event_info)
{
    ...
    if (area_event_info->occurrence_info != OpenAPI_occurrence_info_NULL) {
    if (cJSON_AddStringToObject(item, "occurrenceInfo", OpenAPI_occurrence_info_ToString(area_event_info->occurrence_info)) == NULL) {
...
OpenAPI_area_event_info_t *OpenAPI_area_event_info_parseFromJSON(cJSON *area_event_infoJSON)
{
    ...
    if (!cJSON_IsString(occurrence_info)) {
        ogs_error("OpenAPI_area_event_info_parseFromJSON() failed [occurrence_info]");
        goto end;
    }
