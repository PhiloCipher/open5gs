...
OpenAPI_input_data_t *OpenAPI_input_data_create(
    ...
    OpenAPI_lcs_priority_e priority,
...
cJSON *OpenAPI_input_data_convertToJSON(OpenAPI_input_data_t *input_data)
{
    ...
    if (input_data->external_client_type != OpenAPI_external_client_type_NULL) {
    if (cJSON_AddStringToObject(item, "externalClientType", OpenAPI_external_client_type_ToString(input_data->external_client_type)) == NULL) {
    ...
    if (input_data->supported_gad_shapes != OpenAPI_supported_gad_shapes_NULL) {
    ...
    if (cJSON_AddStringToObject(item, "priority", OpenAPI_lcs_priority_ToString(input_data->priority)) == NULL) {
    ...
    if (cJSON_AddStringToObject(item, "velocityRequested", OpenAPI_velocity_requested_ToString(input_data->velocity_requested)) == NULL) {
    ...
    if (cJSON_AddStringToObject(item, "ldrType", OpenAPI_ldr_type_ToString(input_data->ldr_type)) == NULL) {
    ...
    if (input_data->reporting_access_types != OpenAPI_reporting_access_type_NULL) {
    ...
    OpenAPI_list_for_each(input_data->reporting_access_types, node) {
        if (cJSON_AddStringToObject(reporting_access_typesList, "", OpenAPI_reporting_access_type_ToString((intptr_t)node->data)) == NULL) {
            ogs_error("OpenAPI_input_data_convertToJSON() failed [reporting_access_types]");
            goto end;
        }
    }
    ...
    if (cJSON_AddStringToObject(item, "ueLocationServiceInd", OpenAPI_ue_location_service_ind_ToString(input_data->ue_location_service_ind)) == NULL) {
...
OpenAPI_input_data_t *OpenAPI_input_data_parseFromJSON(cJSON *input_dataJSON)
{
    ...
    if (!cJSON_IsString(external_client_type)) {
        ogs_error("OpenAPI_input_data_parseFromJSON() failed [external_client_type]");
        goto end;
    }
    external_client_typeVariable = OpenAPI_external_client_type_FromString(external_client_type->valuestring);
    }
    ...
    if (supported_gad_shapes) {
        ...
        if (supported_gad_shapesList->count == 0) {
            ogs_error("OpenAPI_input_data_parseFromJSON() failed: Expected supported_gad_shapesList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsString(priority)) {
        ogs_error("OpenAPI_input_data_parseFromJSON() failed [priority]");
        goto end;
    }
    priorityVariable = OpenAPI_lcs_priority_FromString(priority->valuestring);
    }
    ...
    if (!cJSON_IsString(velocity_requested)) {
        ogs_error("OpenAPI_input_data_parseFromJSON() failed [velocity_requested]");
        goto end;
    }
    velocity_requestedVariable = OpenAPI_velocity_requested_FromString(velocity_requested->valuestring);
    }
    ...
    if (!cJSON_IsString(ldr_type)) {
        ogs_error("OpenAPI_input_data_parseFromJSON() failed [ldr_type]");
        goto end;
    }
    ...
    if (reporting_access_types) {
        ...
        cJSON_ArrayForEach(reporting_access_types_local, reporting_access_types) {
            OpenAPI_reporting_access_type_e localEnum = OpenAPI_reporting_access_type_NULL;
            if (!cJSON_IsString(reporting_access_types_local)) {
                ogs_error("OpenAPI_input_data_parseFromJSON() failed [reporting_access_types]");
                goto end;
            }
            localEnum = OpenAPI_reporting_access_type_FromString(reporting_access_types_local->valuestring);
            if (!localEnum) {
                ogs_info("Enum value \"%s\" for field \"reporting_access_types\" is not supported. Ignoring it ...",
                         reporting_access_types_local->valuestring);
            } else {
                OpenAPI_list_add(reporting_access_typesList, (void *)localEnum);
            }
        }
        if (reporting_access_typesList->count == 0) {
            ogs_error("OpenAPI_input_data_parseFromJSON() failed: Expected reporting_access_typesList to not be empty (after ignoring unsupported enum values).");
            goto end;
        }
    }
    ...
    if (!cJSON_IsString(ue_location_service_ind)) {
        ogs_error("OpenAPI_input_data_parseFromJSON() failed [ue_location_service_ind]");
        goto end;
    }
    ue_location_service_indVariable = OpenAPI_ue_location_service_ind_FromString(ue_location_service_ind->valuestring);
    }
