...
OpenAPI_reporting_area_t *OpenAPI_reporting_area_create(
    OpenAPI_reporting_area_type_e area_type,
    OpenAPI_tai_t *tai,
    OpenAPI_ecgi_t *ecgi,
    OpenAPI_ncgi_t *ncgi
)
...
cJSON *OpenAPI_reporting_area_convertToJSON(OpenAPI_reporting_area_t *reporting_area)
{
    ...
    if (reporting_area->area_type == OpenAPI_reporting_area_type_NULL) {
        ogs_error("OpenAPI_reporting_area_convertToJSON() failed [area_type]");
        return NULL;
    }
    if (cJSON_AddStringToObject(item, "areaType", OpenAPI_reporting_area_type_ToString(reporting_area->area_type)) == NULL) {
        ogs_error("OpenAPI_reporting_area_convertToJSON() failed [area_type]");
        goto end;
    }
...
OpenAPI_reporting_area_t *OpenAPI_reporting_area_parseFromJSON(cJSON *reporting_areaJSON)
{
    ...
    OpenAPI_reporting_area_type_e area_typeVariable = 0;
    cJSON *tai = NULL;
    ...
    area_typeVariable = OpenAPI_reporting_area_type_FromString(area_type->valuestring);
