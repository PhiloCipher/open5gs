...
cJSON *OpenAPI_location_data_convertToJSON(OpenAPI_location_data_t *location_data)
{
    ...
    if (location_data->accuracy_fulfilment_indicator != OpenAPI_accuracy_fulfilment_indicator_NULL) {
    if (cJSON_AddStringToObject(item, "accuracyFulfilmentIndicator", OpenAPI_accuracy_fulfilment_indicator_ToString(location_data->accuracy_fulfilment_indicator)) == NULL) {
...
OpenAPI_location_data_t *OpenAPI_location_data_parseFromJSON(cJSON *location_dataJSON)
{
    ...
    OpenAPI_accuracy_fulfilment_indicator_e accuracy_fulfilment_indicatorVariable = 0;
    ...
    if (!cJSON_IsString(accuracy_fulfilment_indicator)) {
        ogs_error("OpenAPI_location_data_parseFromJSON() failed [accuracy_fulfilment_indicator]");
        goto end;
    }
    accuracy_fulfilment_indicatorVariable = OpenAPI_accuracy_fulfilment_indicator_FromString(accuracy_fulfilment_indicator->valuestring);
    }
