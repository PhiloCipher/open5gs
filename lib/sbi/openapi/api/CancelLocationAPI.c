...
//
void
CancelLocationAPI_cancelLocation(apiClient_t *apiClient, cancel_loc_data_t * cancel_loc_data )
{
    ...
    {
        //string
        localVarSingleItemJSON_cancel_loc_data = cancel_loc_data_convertToJSON(cancel_loc_data);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_cancel_loc_data);
    }
